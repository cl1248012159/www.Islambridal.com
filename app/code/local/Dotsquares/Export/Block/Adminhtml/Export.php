 ...
 */
class Dotsquares_Export_Block_Adminhtml_Export extends Mage_Adminhtml_Block_Abstract
{
	...
	public function getScope($val) {
		$retarray = Mage::getModel('dotsquares_core/attribute')->getScopes();
		if (isset($retarray[$val])) return $retarray[$val];
		return $val;
	}

	public function getLayeredNavigation($val) {
		$retarray = Mage::getModel('dotsquares_core/attribute')->getLayeredNavigations();
		if (isset($retarray[$val])) return $retarray[$val];
		return $val;
	}

	public function getInputType($val) {
		$retarray = Mage::getModel('dotsquares_core/attribute')->getInputTypes();
		if (isset($retarray[$val])) return $retarray[$val];
		return $val;
	}

	public function getInputValidation($val) {
		$retarray = Mage::getModel('dotsquares_core/attribute')->getInputValidations();
		if (isset($retarray[$val])) return $retarray[$val];
		return $val;
	}
